...
<html>
 ...
 <!--
	function add(){
		window.location.href="/thinkphp/Admin/Index/add";
	}
	function edit(id){
		window.location.href="/thinkphp/Admin/Index/edit/id/"+id;
	}
	function del(id){
		window.location.href="/thinkphp/Admin/Index/delete/id/"+id;
	}
 //-->
 </script>
 <div class="main">
